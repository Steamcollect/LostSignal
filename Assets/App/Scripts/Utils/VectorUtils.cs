...
public static class VectorUtils
{
      ...
      public static float Max(this Vector3 vector) => Mathf.Max(vector.x, Mathf.Max(vector.y, vector.z));
      
      public static float Min(this Vector3 vector) => Mathf.Min(vector.x, Mathf.Min(vector.y, vector.z));
